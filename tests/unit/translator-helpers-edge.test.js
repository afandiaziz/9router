...
describe("normalizeClaudePassthrough — haiku adaptive thinking (docs 11 §1)", () => {
  ...
  it("folds mid-conversation system messages into the neighbouring user turn", () => {
    // v0.5.55 re-anchors passthrough caching: mid-conversation system messages
    // are folded into the adjacent user turn (not hoisted to top-level system)
    // so the cached prefix stays stable across requests.
